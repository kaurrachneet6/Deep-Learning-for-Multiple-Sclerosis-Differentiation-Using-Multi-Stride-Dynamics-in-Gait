...
class MSResNetRaw(nn.Module):
    def __init__(self, in_chans, layers, num_classes):
        ...
        super(MSResNetRaw, self).__init__()
        ...
        self.maxpool3 = nn.AvgPool1d(kernel_size=52, stride=6, padding=0)
        ...
        self.maxpool5 = nn.AvgPool1d(kernel_size=40, stride=6, padding=0)
